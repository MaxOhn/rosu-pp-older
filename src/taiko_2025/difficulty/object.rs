...
impl TaikoDifficultyObject {
    pub fn new(
        ...
        let curr_control_point_bpm =
            util::control_points::timing_point_at(&map.timing_points, normalized_start_time)
...
fn calculate_slider_velocity(
    ...
    let active_effect_control_point_scroll_speed =
        util::control_points::effect_point_at(&map.effect_points, start_time)
